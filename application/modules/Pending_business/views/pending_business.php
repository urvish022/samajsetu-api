...
<div class="page-content-wrapper">
   ...
   <div class="page-content">
      ...
      <div class="page-bar">
         ...
         <ul class="page-breadcrumb">
            ...
            <li>
               ...
               <span><?=$this->lang->line('pending_business_ttl');?></span>
      ...
      <h1 class="page-title sbold"><?=$this->lang->line('pending_business_ttl');?>

         <small><?=$this->lang->line('pending_business_desc');?></small>
                        ...
                        <div class="portlet light portlet-fit portlet-datatable">
                           ...
                           <div class="portlet-title">
                              ...
                              <div class="caption">
                                 ...
                                 <span class="caption-subject sbold uppercase"><?=$this->lang->line('view_pend_bc');?></span>
                        ...
                        <div class="portlet light portlet-fit portlet-form">
                           ...
                           <div class="portlet-title">
                              ...
                              <div class="caption">
                                 ...
                                 <span class="caption-subject sbold uppercase"> <?=$this->lang->line('edit_pend_bc');?></span>
...
var business_approve_url = "<?=base_url('Pending_business/approve_business')?>";

var reject_url = '<?=base_url('Pending_business/reject_business')?>';

var view_datatable_url = "<?=base_url('Pending_business/view_datatable_business')?>";     

var get_business_data = "<?=base_url('Pending_business/get_business_data')?>";

var delete_buiness_url = "<?=base_url('Pending_business/delete_buiness')?>";

var crop_image_url = "<?=base_url('Pending_business/crop_photo')?>";

var send_notification = "<?=base_url('Pending_business/send_fcm_notify')?>";

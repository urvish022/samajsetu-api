...
class Apis extends MY_controller
{
    ...
    public function view_dashboard_ui()
    {
        ...
        if (empty($list) && empty($slider_list)) {
            $json = json_encode([
                ...
                "member_message" => "",
                "app_version" => "1.0",
                "app_msg" => "You are using currently version",
                "share_msg" =>
            ...
            $json = json_encode([
                ...
                "app_version" => "1.3",
                "app_msg" =>
                    "સમાજ સેતુ એપ ની નવી અપડેટ આવી છે. જે પ્લે-સ્ટોર પરથી અપડેટ કરવાની રહેશે.",
                "share_msg" =>
                    "New Update Available. Update Samaj Setu App from Google Play Store",
            ]);
        }
        ...
        if (empty($village_id)) {
            ...
            if ($count > 0) {
                ...
                if ($page == 1) {
                    ...
                    //$list = $this->sb->get_list($this->member_details_tbl,$where_array,$columns,$limit,$offset,'full_name_eng','ASC');
                    $list = $this->sb->get_list(
                        $this->member_details_tbl,
                        $where_array,
                        $columns,
    ...
    public function matrimony_single()
    {
        ...
        if (isset($matrimony_id) && !empty($matrimony_id)) {
            ...
            $datas["father_mobile"] = $list->father_mobile;
    ...
    public function carrer_details()
    {
        ...
        if (isset($cpost_id)) {
            if (!empty($cpost_id)) {
                ...
                $data["cpost_photo"] = $row->cpost_photo;
    ...
    public function event_detail()
    {
        ...
        if (isset($event_id) && !empty($event_id)) {
            ...
            $data["event_photo"] = $row->event_photo;
    ...
    public function save_fcm_token()
    {
        ...
        if (
            ...
            if ($fcm_check) {
                ...
                $status = $this->sb->insert($this->fcm_tbl, $insert_ary);
            }
